    ...
    return(
        <Fragment>
            <Container>
                <Item>
                    <img src={LogoImg} alt="" />
                    <p>Lorem Ipsum is simply dummy text of the priting and typesetting industry. Lorem Ipsum has been the industry's</p>
                    <nav>
            ...
            <Copy>
                <p>© Copyrigth - Workside Tecnologia All Rigths Reserved.</p>
                <ul>
